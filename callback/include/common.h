...
using on_callback_t = void (*)(error_code_t _error, std::size_t _bytes, std::shared_ptr<DataBase> _data);
...
void async_write(std::shared_ptr<DataBase> _data, boost::asio::const_buffer _buffer, on_callback_t _on_write);
